...
SELECT 
	ROUND(SUM(CASE WHEN DATEDIFF(deadline,launched) BETWEEN 1 AND 30 AND outcome = 'successful' THEN 1 ELSE 0 END)/
		COUNT(CASE WHEN DATEDIFF(deadline,launched) BETWEEN 1 AND 30 THEN 1 END) * 100,2) AS '1-30 days',
	ROUND(SUM(CASE WHEN DATEDIFF(deadline,launched) BETWEEN 31 AND 60 AND outcome = 'successful' THEN 1 ELSE 0 END)/
        	COUNT(CASE WHEN DATEDIFF(deadline,launched) BETWEEN 31 AND 60 THEN 1 END) * 100,2) AS '31-60 days',
    	ROUND(SUM(CASE WHEN DATEDIFF(deadline,launched) > 60 AND outcome = 'successful' THEN 1 ELSE 0 END)/
...
SELECT 
	CASE WHEN DATEDIFF(deadline,launched) BETWEEN 1 AND 30 THEN '1-30 days'
